...
class N8NService:
    ...
    def __init__(
        ...
        self.webhook_url = os.getenv("N8N_WEBHOOK_URL", "http://localhost:420")
...
class GrokWorkflowBuilder:
    ...
    def __init__(self, xai_api_key: str):
        ...
        # Different models for different tasks (updated to 2026 models)
        self.models = {
            "analysis": "grok-4.3",  # Fast workflow design with reasoning
            "enhancement": "grok-4.3",  # Fast enhancement and validation
            "configuration": "grok-4.3",  # Fast parameter generation
            "complex_analysis": "grok-4.5",  # Most capable for complex workflows
        }
...
"""
        ...
        # OPTIMIZED: Use appropriate models with reasoning effort
        # grok-4.3 with low reasoning effort is fast and capable
