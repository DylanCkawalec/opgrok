> **Monorepo note:** Custom n8n node under `apps/n8n-nodes/`. Optional app shell — not the SuperGrok harness kernel (`core/`). See [apps/README.md](../../README.md) and root [README.md](../../../README.md).
