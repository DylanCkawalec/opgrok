...
mod tests {
    ...
    async fn test_create_and_get_session() {
        ...
        let session = ChatSession::new("grok-4.5".to_string(), Some("Test Session".to_string()));
        ...
        assert_eq!(retrieved_session.model, "grok-4.5");
    }
    ...
    async fn test_create_and_get_messages() {
        ...
        let session = ChatSession::new("grok-4.5".to_string(), None);
        ...
        assert_eq!(messages[1].model, Some("grok-4.5".to_string()));
    }
    ...
    async fn test_list_sessions() {
        ...
        let session1 = ChatSession::new("grok-4.5".to_string(), Some("Session 1".to_string()));
        let session2 = ChatSession::new("grok-4.3".to_string(), Some("Session 2".to_string()));
