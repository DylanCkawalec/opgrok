...
<body>
    <div class="container">
        ...
        <div class="endpoint">
            ...
            <p><strong>Body:</strong> <code>{"model": "grok-4.5", "title": "My Chat"}</code></p>
        </div>
        ...
        <div class="endpoint">
            ...
            <p><strong>Body:</strong> <code>{"message": "Hello, Grok!", "model": "grok-4.5"}</code></p>
        </div>
